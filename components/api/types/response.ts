...
export class Response {
   ...
   * @returns
   */
  badRequest(validationResults: openapi.models.ValidationErrorSchema[]): Response {
    this.statusCode = 400
  ...
  buildResponse(
    ...
    body: any = undefined,
  ): openapi.models.StandardResponseSchema {
    return {
      status,
      message,
      stack,
  ...
  buildValidationResponse(
    validation: openapi.models.ValidationErrorSchema[] = [],
    stack: string | undefined = undefined,
